...
class ChatZimFilesDialog(QDialog):
    ...
    def load_settings(self):
        fileName, _ = QFileDialog.getOpenFileName(self, "Load ChatZim Pages", "", "PAGES Files (*.pages);;All Files (*)")
        if fileName:
    ...
    def save_settings(self):
        fileName, _ = QFileDialog.getSaveFileName(self, "Save ChatZim Pages", "", "PAGES Files (*.pages);;All Files (*)")
        if fileName:
